#verificar, pois este arquivo parece que pode ser excluído
#gera df.to_csv('contratos_final1.xlsx', index=False, encoding='utf-8')
...
#df.to_csv('contratos_final1.xlsx', index=False, encoding='utf-8')
#
