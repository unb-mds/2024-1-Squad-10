...
def send_formspree(name, email, subject, message, formspree_url):
    data = {"NOME": name, "EMAIL": email, "ASSUNTO": subject, "MENSAGEM": message}
...
def render_form_ui():
    ...
    st.markdown(
        "Entre em contato com a equipe desenvolvedora desse projeto usando o formulário abaixo:"
    )
    ...
    with st.form(key="contact_form"):
        ...
        if submit_button:
            ...
            result = process_form_submission(
                name, email, subject, message, formspree_url
            )
