...
def generate_html_with_css(html_content, css_content, logo_base64, licitacao_base64):
    html_content = html_content.replace(
        "images/licitanow.png", f"data:image/png;base64,{logo_base64}"
    )
    html_content = html_content.replace(
        "images/licitacao.png", f"data:image/png;base64,{licitacao_base64}"
    )
...
def main(base_dir):
    ...
    html_with_css = generate_html_with_css(
